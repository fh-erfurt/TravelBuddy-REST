...
public class JpaGenericDao< T , ID extends Serializable> {
    ...
    public void setEntityManager(final EntityManager entityManager) {this.entityManager = entityManager;}

    public Class<T> getPersistenceClass(){return persistenceClass;}
